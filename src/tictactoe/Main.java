...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    ReadonlyTttModel readOnly = new TicTacToeModel();
    TicTacToeView view = new TicTacToeSwingView(readOnly);
    TicTacToeController controller = new ControllerMain(readOnly, view);
    controller.playGame((TicTacToe) readOnly);
  }
}
